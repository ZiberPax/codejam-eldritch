...
console.log(`Самооценка 90 баллов:
- 4 карты древних (5*3 = 20 баллов);
- 2 уровня сложности (5*3 = 10 баллов);
- карты замешиваются по правилам игры (40 баллов);
- трекер текущего состояния колоды (20 баллов)`
)
